...
selected_tab = st.sidebar.radio("Navigation", ["Introduction", "Data", "EDA", "Encoding Process", "Machine Learning Model", "Analysis", "Ethical Consideration", "GitHub"], key="navigation")
